...
calc_labeling_efficiency <- function(filtered.data)
{
  ...
  # num_fully_labeled, num_partially_labeled, num_unlabeled, num_no_sites_available, num_overlabeled,
  num.fully.labeled <- sum(filtered.data$labelling_efficiency == "Fully Labelled")
  print(num.fully.labeled)
  num.partially.labeled <- sum(filtered.data$labelling_efficiency == "Partially Labelled")
  print(num.partially.labeled)
  num.unlabeled <- sum(filtered.data$labelling_efficiency == "Unlabelled")
  print(num.unlabeled)
  #percent_fully_labeled, percent_partially_labeled, percent_unlabeled, percent_no_sites_available, percent_overlabeled,
